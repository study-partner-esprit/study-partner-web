...
const NotificationBell = () => {
  ...
  return (
    ...
    >
      ...
      {unreadCount > 0 && (
        <span className="absolute -top-1 -right-1 bg-[var(--accent-color-dynamic)] text-white text-xs font-bold rounded-full min-w-[18px] h-[18px] flex items-center justify-center px-1">
