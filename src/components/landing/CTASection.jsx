...
import { ArrowRight, Sparkles, Trophy, Star, Zap, Gift, Crown, Rocket } from 'lucide-react';
import TiltCard from '@/components/ui/TiltCard';

const CTASection = () => {
  const rewards = [
    { icon: Star, text: "Earn 500 XP on signup", color: "text-yellow-500", glow: "shadow-yellow-500/50" },
    { icon: Trophy, text: "Unlock welcome badge", color: "text-primary", glow: "shadow-primary/50" },
    { icon: Gift, text: "Get free study templates", color: "text-red-400", glow: "shadow-red-400/50" },
    { icon: Zap, text: "Start your first quest", color: "text-primary", glow: "shadow-primary/50" },
  ];
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-white/40 via-transparent to-transparent opacity-50 pointer-events-none" />
              ...
              >
                ...
                >
                  ...
                  <span className="font-bold text-primary tracking-wide uppercase text-sm">🎮 Ready to Level Up?</span>
                  <motion.div
                    animate={{ rotate: [0, -10, 10, 0] }}
                ...
                >
                  Start your gamified learning journey today and unlock your full academic potential.
                  Join thousands of students already leveling up their grades!
                </motion.p>
